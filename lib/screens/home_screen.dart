              ...
              builder: (context, state) {
                if (state is ProfileDoneState) {
                  ...
                  return Text(
                    "Lorem ipsum blabla",
                    style: boldText.copyWith(
                        fontSize: 22, color: Colors.transparent),
                  );
                }
              },
            ),
                                          ...
                                          onTap: () {
                                            ...
                                            showDialog(
                                              ...
                                              builder: (dialogContext) =>
                                                ...
                                                actionsPadding: EdgeInsets.symmetric(vertical: 9, horizontal: 24),
                                                actions: [
                                                  TextButton(
                                                      onPressed: () {
                                                        context
                                  ...
                                  builder: (context, state) {
                                    if (state is TodoLoadingState) {
                                      ...
                                      return ListView.builder(
                                        shrinkWrap: true,
                                        itemCount:
                                            state.todoList.todoList.length,
                                        itemBuilder: (context, index) =>
                                            Padding(
                                          padding:
